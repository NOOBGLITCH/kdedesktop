...
CRD_SSH_Code = input("DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0ASVgi3InNpRmnfJe7VxL9KW9FsPc1FheCQwLXY38EreczFqPRbwUfzGDgla9pV59KBiU4w" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname):")
